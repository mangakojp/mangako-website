...
export const FeaturedGallery = () => {
    ...
    const artworks = [
        { img: "/mangako/poster-01.png", title: t("gallery.items.0.title"), subtitle: t("gallery.items.0.subtitle"), slug: "vagabond-volume-1" },
        { img: "/mangako/poster-02.png", title: t("gallery.items.1.title"), subtitle: t("gallery.items.1.subtitle"), slug: "akira-complete-set" },
        { img: "/mangako/poster-03.png", title: t("gallery.items.2.title"), subtitle: t("gallery.items.2.subtitle"), slug: "berserk-deluxe-1" },
        { img: "/mangako/poster-04.png", title: t("gallery.items.3.title"), subtitle: t("gallery.items.3.subtitle"), slug: "nausicaa-box-set" },
    ];
            ...
            <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                    ...
                    <div className="flex-none">
                        <Link to="/collection" className="inline-block text-mangako-ink font-sans tracking-widest text-sm uppercase px-12 py-5 border-2 border-mangako-ink hover:bg-mangako-ink hover:text-mangako-ivory transition-colors duration-300">
                            {t("gallery.button")}
                        </Link>
                    </div>
                </div>
